...
for i=1:100
    ...
    writematrix(R_q', sprintf('../../Data/weights/Multi Deep/fc1_%d_3_%d.csv', i-1, p))
    writematrix(W_q', sprintf('../../Data/weights/Multi Deep/fc2_%d_3_%d.csv', i-1, p))
    
    writematrix(X_v, sprintf('../../Data/points/Multi Deep/xv_%d_3_%d.csv', i-1, p))
    
    writematrix(YT(i), sprintf('../../Data/labels/Multi Deep/yt_%d_3_%d.csv', i-1, p))
end