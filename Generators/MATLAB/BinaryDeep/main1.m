...
for i = 1:100
    ...
    writematrix(R_q', sprintf("../../Data/weights/Binary Deep/fc1_%d_2_%d.csv", i-1, p))
    writematrix(w_q', sprintf("../../Data/weights/Binary Deep/fc2_%d_2_%d.csv", i-1, p))
    
    writematrix(X_v, sprintf("../../Data/points/Binary Deep/xv_%d_2_%d.csv", i-1, p))
    
    writematrix(YT(i), sprintf("../../Data/labels/Binary Deep/yt_%d_2_%d.csv", i-1, p))
end