...
for i = 1:100
    ...
    writematrix(w_q', sprintf('../../Data/weights/Binary Linear/w_%d_0_%d.csv', i-1, p))
    
    writematrix(X_v, sprintf('../../Data/points/Binary Linear/xv_%d_0_%d.csv', i-1, p))
    
    writematrix(YT(i), sprintf('../../Data/labels/Binary Linear/yt_%d_0_%d.csv', i-1, p))
end