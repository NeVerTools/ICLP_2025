...
writematrix(w_q', sprintf('../../Data/weights/w_%d_0_%d.csv', i-1, p))

writematrix(X_v, sprintf('../../Data/points/xv_%d_0_%d.csv', i-1, p))

writematrix(YT(i), sprintf('../../Data/labels/yt_%d_0_%d.csv', i-1, p))